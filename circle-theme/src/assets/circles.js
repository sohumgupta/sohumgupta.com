...
class Circles extends React.Component {
	render() {
		...
		const style1 = {
			...
			backgroundImage: "linear-gradient(to bottom right, #F7A29C, rgba(247, 162, 156, " + (.5 - gradient*dist) + ")",
		}
		
		const style2 = {
			bottom: (5 - movement*dist) + "vw",
			right: (5 - movement*dist) + "vw",
			backgroundImage: "linear-gradient(to top left, #F7A29C, rgba(247, 162, 156, " + (gradient*dist) + ")",
		}
