		...
		return (
			<ProjectPage
				...
				<div className="project-page-picture">
					...
					<div className="project-page-caption"><p>This angle shows how the museum interacts with its environment.</p></div>
				</div>
				...
				<div className="project-page-picture">
					...
					<div className="project-page-caption"><p>A top view, showing the layout and topography of the landscape around the museum.</p></div>
				</div>
				...
				<div className="project-page-picture">
					...
					<div className="project-page-caption"><p>A close-up of the twist, modeled using a Python script.</p></div>
				</div>
			</ProjectPage>
		)
	}
